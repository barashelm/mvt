...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model: int = 64, nhead: int = 8, num_encoder_layers: int = 6,
                 ...
                 layer_norm_eps: float = 1e-5, batch_first: bool = False, reduction=64, nbit=8, qmode='none') -> None:
...
def transnet(reduction=4, d_model=64):
    model = Transformer(d_model=d_model, num_encoder_layers=2, num_decoder_layers=2, nhead=2, reduction=reduction,
                        dropout=0.)
    return model
