...
from models.quantization import FakeQuant, hquan, muquan, pquan, tquan, btquan, cquan
...
class ACRNet(nn.Module):
    def __init__(self,
        ...
        self.codeqt = None
        self.sig_qt = nn.Sigmoid()
        # self.codeqt = hquan(nbit=3)
        # self.codeqt = muquan(nbit=6)
        # self.codeqt = pquan(nbit=6)
        # self.codeqt = btquan(nbit=3, k_min=8, k_max=128., total_epochs=args.epochs)
        # self.codeqt = cquan(nbit=3)
